...
function EditClasses({ sections }) {
  ...
  return (
    ...
    <div>
      <h3 className="text-xl items-center font-bold mx-4 my-4">Edit Class Sections</h3>
  ...
  {editedSections.map((section, index) => (
    <div className="flex flex-col w-80 transition-transform border border-orange-500 p-4 rounded transform hover:scale-105" key={section.id}>
